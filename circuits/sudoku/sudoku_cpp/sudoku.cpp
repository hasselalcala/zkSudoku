...
Fr_sub(&expaux[2],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 243)]].signalStart + 0]); // line circom 48
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 162)]].signalStart + 0],&expaux[2]); // line circom 48
...
Fr_add(&expaux[2],&lvar[3],&circuitConstants[6]); // line circom 107
Fr_lt(&expaux[0],&lvar[5],&expaux[2]); // line circom 107
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 108
Fr_lt(&expaux[0],&lvar[6],&expaux[2]); // line circom 108
while(Fr_isTrue(&expaux[0])){
{
